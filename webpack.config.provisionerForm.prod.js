...
export default {
  ...
  entry: ["babel-polyfill","whatwg-fetch","webpack-hot-middleware/client?reload=true","./src/apps/provisionerForm"],
  target:"web", // necessary per https://webpack.github.io/docs/testing.html#compile-and-test
  output: {
    path: `${__dirname}/dist/provisionerForm/`,
    publicPath:"/",
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({"process.env.NODE_ENV": JSON.stringify("production"),"process.env.HOST": JSON.stringify(hosts.PRODUCTION),
      __DEV__: false
    }),
